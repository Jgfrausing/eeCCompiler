...
internal class MyParser
{
    ...
    public SourceCode SourceCode; //You might derive a specific object
        ...
        while (!done)
        {
            ...
            switch (response)
            {
                ...
                case ParseMessage.Accept:
                    //Accepted!
                    SourceCode = Stack.Pop() as SourceCode;
                    done = true;
                    accepted = true;
                    break;
                ...
                case ParseMessage.LexicalError:
                    ...
                    Console.WriteLine("______________________________________________________");
                    Console.WriteLine("Data: " + _parser.CurrentToken().Data);
                    Console.WriteLine("Parent: " + _parser.CurrentToken().Parent);
                    Console.WriteLine("Position: " + _parser.CurrentToken().Position());
                    Console.WriteLine("Type: " + _parser.CurrentToken().Type());
                    done = true;
                    break;
    ...
    private AbstractSyntaxTree CreateProgram(AbstractSyntaxTree result)
    {
        ...
        return new SourceCode(constantList.ConstantList, structDef.Definitions, body, funcDecls);
    }
